...
import { mockDua, nexoraCoreDuaRepository, type Dua, type DuaPort } from '@/lib/dua';
export default function DuaScreen() {
 ...
 const [items,setItems]=useState<Dua[]>([]); const [favorites,setFavorites]=useState<string[]>([]);
