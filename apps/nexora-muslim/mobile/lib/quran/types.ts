...
export type QuranReadingStatistics = { goal: QuranReadingGoal; today: { pages: number; minutes: number; pagesProgress: number; minutesProgress: number }; currentStreak: number; total: { pages: number; minutes: number }; };
