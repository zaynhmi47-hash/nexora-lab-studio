    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("global_number", models.PositiveIntegerField(blank=True, null=True)),
        ...
        migrations.AddConstraint(migrations.AlterUniqueTogether(name="quranayah", unique_together={("surah", "number_in_surah")})),
        migrations.AddConstraint(migrations.AddConstraint if False else models.UniqueConstraint(fields=("user", "ayah"), name="quran_user_ayah_bookmark_unique")),
